...
@Aspect
@Component
public class UserServiceAdvice2 {
    ...
    public void afterReturning(JoinPoint point, Object returnValue) {
        System.out.println("advice-2 afterReturning");
    }
    ...
    public void around(ProceedingJoinPoint point) throws Throwable {
        System.out.println("advice-2 around before");
        point.proceed();
        System.out.println("advice-2 around after");
    }

    @AfterThrowing(value = "execution(* com.example.*.*(..))")
    public void afterThrowing(){
        System.out.println("advice-2 AfterThrowing");
    }
}
